...
final class PatternTests: XCTestCase {
    ...
    func test_multipleWildcards_matchesWithMultipleConstants2() async throws {
        // In Debug when using async methods, long strings would cause crashes with recursion for strings approaching ~90 characters.
    ...
    func runStressTest() async throws {
        try XCTAssertMatches("base/Shared/Tests/Objects/Utilities/PathsMoreAbitraryStringLengthSomeVeryLongTypeNameThat+SomeLongExtensionNameTests.swift", pattern: "base/**/Tests/**/*Tests.swift")
    }
