...
- Disable renovate ahead of the monorepo migration by @esnunes in [#404](https://github.com/tuist/FileSystem/pull/404)
...
### Details
#### <!-- 0 -->🚀 Features
- Let callers choose the zip compression method by @fortmarek in [#398](https://github.com/tuist/FileSystem/pull/398)

## [0.18.0] - 2026-05-09
### Details
#### <!-- 0 -->🚀 Features
- Add file operation backpressure by @pepicrft in [#345](https://github.com/tuist/FileSystem/pull/345)
...
[0.19.2]: https://github.com/tuist/FileSystem/compare/0.19.1..0.19.2
